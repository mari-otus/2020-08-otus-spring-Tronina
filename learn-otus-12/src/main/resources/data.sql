...
insert into user_library(id, login, password, locked, account_expired, password_expired, enabled) values
    (1, 'admin', '$2a$10$E7CswtV8IX36w0iPW//rlu5ptkxvTrOZtVUEIWLQiFOUnQYfe3T42', false, null, null, true);